    ...
    def get_events(self):
        ...
        for event in events:
            if event.type == pygame.WINDOWCLOSE:
                ...
                program.button_handler(True, event.key, 0.5, self.is_shifting)
                ...
                program.button_handler(False, event.key, 0.5, self.is_shifting)
        ...
        if event.button == 1:
            ...
            for surface in self.surfaces:
                for element in surface.elements:
                    ...
                    if element.type == "Button" or element.type == "LabelledButton":
                        if element.is_highlighted:
                            program.button_handler(False, element.unicode_id, element.needs_shift, element.needs_shift)
